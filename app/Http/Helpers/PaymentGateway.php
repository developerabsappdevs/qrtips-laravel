...
use App\Traits\PaymentGateway\TapPayment;

class PaymentGateway {

    use Paypal, Gpay, CoinGate, QRPay, Tatum, Stripe, Flutterwave, SslCommerz, Razorpay, PerfectMoney,Authorize,TapPayment;
    ...
    public static function getToken(array $response, string $gateway) {
        switch($gateway) {
            ...
            case PaymentGatewayConst::SSLCOMMERZ:
                return $response['token'] ?? "";
                break;
            case PaymentGatewayConst::TAP_PAYMENT:
                return $response['tap_id'] ?? "";
                break;
