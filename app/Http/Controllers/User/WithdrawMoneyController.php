...
class WithdrawMoneyController extends Controller
{
   ...
   public function confirmMoneyOut(Request $request) { 
    ...
    $get_values = $this->placeValueWithFields($payment_fields,$payment_field_validate);
        ...
        return redirect()->route("user.withdraw.money.index")->with(['success' => [__('Withdraw money request send to admin successfully')]]);
   } 
   public function insertRecordManual($moneyOutData,$gateway,$get_values) {
        ...
        try{
            ...
            $notification_content = [
                ...
                'message'       => "Your withdraw money request send to admin " .$moneyOutData->amount.' '.$moneyOutData->request_currency." Successfully",
            ...
            $notification_content = [
                'title'         => " Withdraw Money",
                'message'       => "Withdraw money request " .$moneyOutData->amount.' '.$moneyOutData->request_currency,
                'image'         => files_asset_path('profile-default'),
            ];
