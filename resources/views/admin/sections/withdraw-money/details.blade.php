...
<div class="custom-card">
    <div class="card-header">
        <h6 class="title">{{ __("Withdraw Money Details") }}</h6>
    </div>
    <div class="card-body">
        <form class="card-form">
            <div class="row align-items-center mb-10-none">
                ...
                <div class="col-xl-4 col-lg-4 form-group">
                    <ul class="user-profile-list two">
                        <li class="one">Fees &Charge: <span>{{ number_format(@$data->total_charge,2) }} {{ @$data->gateway_currency->currency_code }}</span></li>
                        ...
                        <li class="three">Rate: <span>1 {{ $data->request_currency }} = {{ number_format(@$data->exchange_rate,2) }} {{ @$data->gateway_currency->currency_code }}</span></li>
                        <li class="four">Will Get: <span>{{ get_amount(@$data->receive_amount,$data->gateway_currency->currency_code) }}</span></li>
                        <li class="four">Payable: <span>{{ get_amount(@$data->total_payable,$data->gateway_currency->currency_code) }}</span></li>
...
<div class="modal fade" id="approvedModal" tabindex="-1" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="modal-form" action="{{ setRoute('admin.withdraw.money.approved') }}" method="POST">
                @csrf
...
<div class="modal fade" id="rejectModal" tabindex="-1" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="modal-form" action="{{ setRoute('admin.withdraw.money.rejected') }}" method="POST">
                @csrf
                @method("PUT")
                <div class="modal-body">
