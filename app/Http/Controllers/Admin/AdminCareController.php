...
class AdminCareController extends Controller
{
    ...
    public function rolePermissionStore(Request $request)
    {
        ...
        if(AdminRolePermission::where('admin_role_id',$validated['admin_role_id'])->exists()){
            return back()->with(['error' => ['Sorry ! You can not add multiple permission with the same role.']]);
        }
